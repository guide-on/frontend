...
const SupportCenterCard: React.FC<SupportCenterCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-5 animate-slide-up transition-all duration-300 hover:shadow-xl">
      {/* 사업장 주소 태그 */}
      {businessAddress && (
      ...
      <div className="space-y-3 mb-4">
        ...
        {/* 주소 */}
        <div
          className="bg-gray-50 rounded-lg p-3 transition-all duration-200 hover:bg-gray-100 hover:shadow-md animate-slide-up"
        ...
        >
          ...
          <div className="text-sm text-gray-700">{center.address}</div>
        </div>
        ...
        >
          ...
          <div className="space-y-1">
            ...
            {center.fax && (
              <div className="text-sm text-gray-600">팩스: {center.fax}</div>
            )}
          </div>
        </div>
      </div>
