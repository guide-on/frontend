      ...
      <div className="relative bg-white rounded-2xl p-6 mx-4 max-w-sm w-full shadow-xl">
          ...
          <div className="flex justify-center items-center mb-6">
            <div className="flex items-center gap-3">
              <div className="flex flex-col items-center">
                ...
                <span className="text-[8px] mt-1 text-gray-600">서류 검증</span>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-[8px] mt-1 text-gray-600">결과 확인</span>
              </div>
            </div>
          </div>
        ...
        <div className="flex gap-3">
          <button
            onClick={onClose}
            disabled={isApplying}
            className={`flex-1 py-3 rounded-lg font-semibold border bg-white border-gray-200 ${
