...
interface EsgStepSectionProps {
  esgStep: number;
  esgFiles: Record<number, string | undefined>;
  esgManual: {
  ...
  onManualChange: (field: keyof typeof esgManual, value: string) => void;
  onStepChange: (step: number) => void;
  onComplete: () => void;
}

export const EsgStepSection: React.FC<EsgStepSectionProps> = ({
  esgStep,
  esgFiles,
  esgManual,
  completed,
          ...
          <div className="grid grid-cols-1 gap-3">
            <label className="text-sm text-gray-700">
              ...
              <input
                ...
                onChange={(e) => onManualChange('energyConsumption', e.target.value)}
              />
            </label>
            <label className="text-sm text-gray-700">
              ...
              <input
                ...
                onChange={(e) => onManualChange('recyclingRate', e.target.value)}
              />
            </label>
            <label className="text-sm text-gray-700">
              ...
              <input
                ...
                onChange={(e) => onManualChange('safetyIncidents', e.target.value)}
              />
            </label>
            <label className="text-sm text-gray-700">
