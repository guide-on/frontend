  ...
  return (
    <div className="px-4 py-6 space-y-5">
      <h2 className="flex items-center justify-between text-base font-bold text-navy">
        <span>항목 선택</span>
        <button aria-label="항목 토글" onClick={() => setListOpen((v) => !v)} className="text-gray-600 hover:text-navy">
          <FaBars />
        </button>
      </h2>
      ...
      <section className="pt-3 space-y-3 border-t border-gray-200">
        ...
        <div className="flex items-center gap-2">
          ...
          <button aria-label="도움말" onClick={() => setHelpModalOpen(true)} className="text-blue hover:text-navy">
            <FaQuestionCircle />
          </button>
        </div>
        ...
        {selected === 'ceo' && (
          <div className="mt-2 rounded-md border p-3 space-y-2 bg-paleBlue/30 border-lightBlue">
            <p className="text-sm text-gray-700">
              ...
              신용점수를 조회하기 위한 서비스 이용 약관 및 개인(신용)정보 조회 동의 절차를 진행합니다.
            </p>
            <button
        ...
        {selected === 'cashflow' && (
          <div className="mt-2 rounded-md border p-3 space-y-2 bg-paleBlue/30 border-lightBlue">
            <p className="text-sm text-gray-700">
              ...
              현금흐름 분석을 위해 사업자(또는 대표자) 명의 계좌를 연결하고 최근 거래내역 조회에 동의해 주세요.
            </p>
            <button
        ...
        {selected !== 'ceo' && selected !== 'cashflow' && (
          <>
            <div className="flex items-center gap-2 pt-2">
              ...
              <button aria-label="도움말" onClick={() => setAttachHelpModalOpen(true)} className="text-blue hover:text-navy">
                <FaQuestionCircle />
              </button>
            </div>
            <UploadCard
        ...
        <button
          ...
          className="mt-4 w-full rounded-md py-3 text-white font-semibold bg-navy hover:bg-blue shadow-md transition"
        >
          제출하기
        </button>
      </section>
        ...
        {selected === 'ceo' ? (
          <div className="space-y-6 text-[12px] text-gray-800">
            <div className="overflow-x-auto">
              <h5 className="mb-2 text-xs font-bold text-gray-700">활용비중 요약</h5>
              <table className="w-full border-collapse rounded-md overflow-hidden border border-gray-200 text-[12px]">
                <thead className="bg-gray-50 text-gray-700">
                  <tr>
                    <th className="border border-gray-200 p-2 text-left font-semibold">평가 요소</th>
                    <th className="border border-gray-200 p-2 text-left font-semibold">상세내용</th>
                    <th className="border border-gray-200 p-2 text-right font-semibold">활용비중</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 p-2">상환이력</td>
                    <td className="border border-gray-200 p-2">현재 연체 및 과거 채무 상환 이력</td>
                    <td className="border border-gray-200 p-2 text-right whitespace-nowrap">
                      28.4%
                      <div className="mt-1 h-1.5 rounded bg-gray-100">
                        <div className="h-full rounded bg-blue" style={{ width: '28.4%' }} />
                      </div>
                    </td>
                  </tr>
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 p-2">부채수준</td>
                    <td className="border border-gray-200 p-2">채무 부담 정보 (대출 및 보증채무 등)</td>
                    <td className="border border-gray-200 p-2 text-right whitespace-nowrap">
                      24.5%
                      <div className="mt-1 h-1.5 rounded bg-gray-100">
                        <div className="h-full rounded bg-blue" style={{ width: '24.5%' }} />
                      </div>
                    </td>
                  </tr>
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 p-2">신용거래기간</td>
                    <td className="border border-gray-200 p-2">신용 거래 기간 (최초/최근 개설로부터 기간)</td>
                    <td className="border border-gray-200 p-2 text-right whitespace-nowrap">
                      12.3%
                      <div className="mt-1 h-1.5 rounded bg-gray-100">
                        <div className="h-full rounded bg-blue" style={{ width: '12.3%' }} />
                      </div>
                    </td>
                  </tr>
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 p-2">신용형태</td>
                    <td className="border border-gray-200 p-2">신용 거래 패턴 (체크/신용카드 이용 정보)</td>
                    <td className="border border-gray-200 p-2 text-right whitespace-nowrap">
                      27.5%
                      <div className="mt-1 h-1.5 rounded bg-gray-100">
                        <div className="h-full rounded bg-blue" style={{ width: '27.5%' }} />
                      </div>
                    </td>
                  </tr>
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 p-2">비금융/마이데이터</td>
                    <td className="border border-gray-200 p-2">비금융/마이데이터정보(성실납부실적 등)</td>
                    <td className="border border-gray-200 p-2 text-right whitespace-nowrap">
                      7.3%
                      <div className="mt-1 h-1.5 rounded bg-gray-100">
                        <div className="h-full rounded bg-blue" style={{ width: '7.3%' }} />
                      </div>
                    </td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="border border-gray-200 p-2 font-semibold">계</td>
                    <td className="border border-gray-200 p-2" />
                    <td className="border border-gray-200 p-2 text-right font-semibold">100.0%</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="overflow-x-auto">
              ...
              <h5 className="mb-2 text-xs font-bold text-gray-700">세부 변동 요인</h5>
              <table className="w-full border-collapse rounded-md overflow-hidden border border-gray-200 text-[12px]">
                <thead className="bg-gray-50 text-gray-700">
                  <tr>
                    <th className="border border-gray-200 p-2 text-left font-semibold">평가영역</th>
                    <th className="border border-gray-200 p-2 text-left font-semibold">신용평가 요소</th>
                    <th className="border border-gray-200 p-2 text-center font-semibold">일반고객군</th>
                    <th className="border border-gray-200 p-2 text-center font-semibold">장기연체군</th>
                    <th className="border border-gray-200 p-2 text-left font-semibold">평가개요</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 align-top p-2" rowSpan={6}>
                      상환이력정보
                    </td>
                    <td className="border border-gray-200 p-2">장기연체 발생</td>
                    ...
                    <td className="border border-gray-200 p-2" rowSpan={6}>
                      단기연체의 기준은 5영업일 10만원 이상이며, 장기연체는 90일 이상 연체 등을 기준으로 하고 있습니다. 단, 임시적 소액연체는 신용평가에 활용되지 않습니다.
                    </td>
                  </tr>
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 p-2">단기연체 발생</td>
                    <td className="border border-gray-200 p-2 text-center">
                      <ScoreChip v="--" />
                    </td>
                    <td className="border border-gray-200 p-2 text-center">
                  ...
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 p-2">연체 진행 일수 증가</td>
                    <td className="border border-gray-200 p-2 text-center">
                      <ScoreChip v="--" />
                    </td>
                    <td className="border border-gray-200 p-2 text-center">
                  ...
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 p-2">연체 해제 일수 경과</td>
                    <td className="border border-gray-200 p-2 text-center">
                      <ScoreChip v="+" />
                    </td>
                    <td className="border border-gray-200 p-2 text-center">
                  ...
                  <tr className="bg-gray-50/60">
                    <td className="border border-gray-200 p-2 font-medium">비중</td>
                    <td className="border border-gray-200 p-2 text-center font-medium">27.4%</td>
                    <td className="border border-gray-200 p-2 text-center font-medium">47.8%</td>
                    <td className="border border-gray-200 p-2" />
                  </tr>

                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 align-top p-2" rowSpan={8}>
                      부채수준
                    </td>
                    <td className="border border-gray-200 p-2">고위험 대출 발생</td>
                    <td className="border border-gray-200 p-2 text-center">
                      <ScoreChip v="--" />
                    </td>
                    <td className="border border-gray-200 p-2 text-center">
                    ...
                    <td className="border border-gray-200 p-2" rowSpan={8}>
                      보증 및 대출의 발생은 상환부담에 따른 신용위험이 있는 것으로 판단되어 평가상 영향력을 행사하며, 반대로 상환 시에는 신용위���이 감소된 것으로 판단되어 신용평점에 긍정적인 영향을 주게 됩니다.
                    </td>
                  </tr>
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 p-2">고위험 외 대출 발생</td>
                    <td className="border border-gray-200 p-2 text-center">
                      <ScoreChip v="-" />
                    </td>
                    <td className="border border-gray-200 p-2 text-center">
                  ...
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 p-2">대출 잔액 증가</td>
                    <td className="border border-gray-200 p-2 text-center">
                      <ScoreChip v="-" />
                    </td>
                    <td className="border border-gray-200 p-2 text-center">
                  ...
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 p-2">대출 분할 상환</td>
                    <td className="border border-gray-200 p-2 text-center">
                      <ScoreChip v="+" />
                    </td>
                    <td className="border border-gray-200 p-2 text-center">
                  ...
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 p-2">대출 전액 상환</td>
                    <td className="border border-gray-200 p-2 text-center">
                      <ScoreChip v="++" />
                    </td>
                    <td className="border border-gray-200 p-2 text-center">
                  ...
                  <tr className="bg-gray-50/60">
                    <td className="border border-gray-200 p-2 font-medium">비중</td>
                    <td className="border border-gray-200 p-2 text-center font-medium">23.6%</td>
                    <td className="border border-gray-200 p-2 text-center font-medium">42.8%</td>
                    <td className="border border-gray-200 p-2" />
                  </tr>

                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 align-top p-2" rowSpan={3}>
                      신용거래기간
                    </td>
                    <td className="border border-gray-200 p-2">신용거래 기간 없음</td>
                    <td className="border border-gray-200 p-2 text-center">
                      <ScoreChip v="-" />
                    </td>
                    <td className="border border-gray-200 p-2 text-center">
                  ...
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 p-2">신용거래 기간 경과</td>
                    <td className="border border-gray-200 p-2 text-center">
                      <ScoreChip v="++" />
                    </td>
                    <td className="border border-gray-200 p-2 text-center">
                  ...
                  <tr className="bg-gray-50/60">
                    <td className="border border-gray-200 p-2 font-medium">비중</td>
                    <td className="border border-gray-200 p-2 text-center font-medium">12.5%</td>
                    <td className="border border-gray-200 p-2 text-center font-medium">9.4%</td>
                    <td className="border border-gray-200 p-2" />
                  </tr>

                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 align-top p-2" rowSpan={5}>
                      신용형태정보
                    </td>
                    <td className="border border-gray-200 p-2">신용/체크카드 사용 개설</td>
                    <td className="border border-gray-200 p-2 text-center">
                      <ScoreChip v="++" />
                    </td>
                    <td className="border border-gray-200 p-2 text-center">
                    ...
                    <td className="border border-gray-200 p-2" rowSpan={5}>
                      연체없이 사용하는 신용카드 사용은 긍정적인 요인이며, 지속/습관적인 할부 및 현금서비스의 과다 사용은 부정적인 영향을 미칩니다.
                    </td>
                  </tr>
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 p-2">신용/체크카드 사용 금액 적정</td>
                    <td className="border border-gray-200 p-2 text-center">
                      <ScoreChip v="+" />
                    </td>
                    <td className="border border-gray-200 p-2 text-center">
                  ...
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 p-2">과다 할부 사용</td>
                    <td className="border border-gray-200 p-2 text-center">
                      <ScoreChip v="-" />
                    </td>
                    <td className="border border-gray-200 p-2 text-center">
                  ...
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 p-2">현금서비스 사용</td>
                    <td className="border border-gray-200 p-2 text-center">
                      <ScoreChip v="-" />
                    </td>
                    <td className="border border-gray-200 p-2 text-center">
                  ...
                  <tr className="bg-gray-50/60">
                    <td className="border border-gray-200 p-2 font-medium">비중</td>
                    <td className="border border-gray-200 p-2 text-center font-medium">28.9%</td>
                    <td className="border border-gray-200 p-2 text-center font-medium">0.0%</td>
                    <td className="border border-gray-200 p-2" />
                  </tr>
                  ...
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    ...
                    <td className="border border-gray-200 p-2" rowSpan={5}>
                      국민연금/건강보험/통신요금/아파트관리비 납부내역, 소득금액증명(소득여부만 확인) 등 비금융정보 제출 시 신용평점에 긍정적 요인으로 반영됩니다. 마이데이터를 통해 등록된 저축성 금융자산(수신 등) 거래내역정보 제출 시 신용평점에 긍정적 요인으로 반영됩니다.
                    </td>
                  </tr>
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 p-2">비금융 성실납부실적</td>
                    <td className="border border-gray-200 p-2 text-center">
                      <ScoreChip v="+" />
                    </td>
                    <td className="border border-gray-200 p-2 text-center">
                  ...
                  <tr className="odd:bg-white even:bg-gray-50/60">
                    <td className="border border-gray-200 p-2">저축성 금융자산(수신 등) 마이데이터 정보</td>
                    <td className="border border-gray-200 p-2 text-center">
                      <ScoreChip v="+" />
                    </td>
                    <td className="border border-gray-200 p-2 text-center">
                  ...
                  <tr className="bg-gray-50/60">
                    <td className="border border-gray-200 p-2 font-medium">비중</td>
                    <td className="border border-gray-200 p-2 text-center font-medium">7.7%</td>
                    <td className="border border-gray-200 p-2 text-center font-medium">0.0%</td>
                    <td className="border border-gray-200 p-2" />
                  </tr>
                </tbody>
            ...
            <p className="text-[11px] text-gray-600">
              학력 등의 민감정보, 현금서비스 소득원 및 신용조회 이력정보는 신용평가에 반영되지 않습니다.
            </p>
          </div>
        ) : (
          <>
            <p className="text-sm text-gray-700">
              항목은 선택된 주제의 세부 평가 요소입니다. 각 항목의 증빙 자료를 함께 제출하면 정확도가 높아집니다.
            </p>
            <div
              className="mt-3 rounded-md p-3 text-xs space-y-1 bg-paleBlue border border-lightBlue"
            >
              <div className="font-semibold text-navy">현재 선택: {content.title}</div>
              {content.items.map((it) => (
                <div key={it} className="flex items-start gap-2">
                  <span>•</span>
                  <span>{it}</span>
      ...
      >
        <div className="space-y-3 text-sm text-gray-700">
          <p>
            신용점수 조회를 위해 아래 약관 및 개인(신용)정보 처리에 동의해 주세요.
          </p>
          <div className="rounded-md border border-gray-200 p-3">
            <div className="text-xs font-bold mb-1">서비스 이용 약관 요약</div>
            <ul className="list-disc pl-4 space-y-1">
              <li>본 서비스는 신용점수 조회 및 신용평가 보조 기능을 제공합니다.</li>
              <li>부정 사용 방지를 위해 본인인증이 필요할 수 있습니다.</li>
              <li>약관은 관련 법령 개정 또는 서비스 정책에 따라 변경될 수 있습니다.</li>
            </ul>
          </div>
          <div className="rounded-md border border-gray-200 p-3">
            <div className="text-xs font-bold mb-1">개인(신용)정보 수집·이용·제공 동의</div>
            <ul className="list-disc pl-4 space-y-1">
              <li>수집 ���목: 성명, 생년월일, 연락처, CI/DI, 신용점수·등급, 대출·연체정보 등.</li>
              <li>이용 목적: 신용점수 조회, 본인확인, 서비스 제공 및 고객 상담.</li>
              <li>보유 기간: 동의일로부터 3년 또는 관련 법령에 따른 기간.</li>
              <li>제공 받는 자: 신용정보회사 및 제휴 신용평가 기관.</li>
              <li>동의 거부 권리 및 불이익: 동의하지 않을 경우 신용점수 조회가 제한됩니다.</li>
            </ul>
          </div>
      ...
      >
        <div className="space-y-3 text-sm text-gray-700">
          <p>
            현금흐름 분석을 위해 사업자(또는 대표자) 명의의 은행 계좌를 연결하고 최근 거래내역 조회에 동의해 주세요.
          </p>
          <div className="rounded-md border border-gray-200 p-3">
            <div className="text-xs font-bold mb-1">동의 내용 요약</div>
            <ul className="list-disc pl-4 space-y-1">
              <li>조회 범위: 최근 거래내역, 잔액, 입·출금 내역 등 분석에 필요한 항목.</li>
