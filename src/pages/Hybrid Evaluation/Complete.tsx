      ...
      `}</style>
        ...
        <div className="w-full max-w-md relative overflow-hidden rounded-2xl border border-lightBlue/60 shadow-sm">
          <div
            ...
            style={{
              background:
                'linear-gradient(135deg, #E8F1FF 0%, #F3F8FF 30%, #E7FFF7 60%, #F5F0FF 100%)',
          ...
          <div
            className="absolute -top-16 left-6 h-48 w-48 rounded-full blur-3xl opacity-40"
            style={{ background: '#93c5fd' }}
          />
          <div
            className="absolute -bottom-20 -right-8 h-56 w-56 rounded-full blur-3xl opacity-30"
          ...
          <div className="relative flex flex-col items-center px-6 py-10 text-center">
            <div className="relative">
              <div
                className="grid h-20 w-20 place-items-center rounded-full bg-white/70 backdrop-blur border border-lightBlue/50 shadow"
                style={{ animation: 'pulseIn 600ms ease-out both' }}
              >
                <svg width="46" height="46" viewBox="0 0 48 48" fill="none">
                  ...
                  <circle
                    ...
                    style={{ animation: 'draw 900ms 150ms ease forwards' }}
                  />
                  <path
                    ...
                    strokeDasharray="36"
                    strokeDashoffset="36"
                    style={{ animation: 'draw 700ms 450ms ease forwards' }}
                  />
                </svg>
              </div>
